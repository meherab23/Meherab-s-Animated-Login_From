...
const usernameEl = document.querySelector('.form-container .form-row input[username="username"]');
const emailEl = document.querySelector('.form-container .form-row input[username="email"]');
...
submitBtn.addEventListener('click', () => {
    if (emailValid && checkboxEl.checked && usernameValid && sprayRepeatCounter > 1) {
        gsap.to("svg > *", {
            duration: .1,
            opacity: 0,
            stagger: {
